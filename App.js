...
function GhostButton({ label, onPress, danger = false }) { return <TouchableOpacity onPress={onPress} style={[styles.buttonGhost, danger && styles.buttonDanger]}><Text style={[styles.buttonGhostText, danger && styles.buttonDangerText]}>{label}</Text></TouchableOpacity>; }
